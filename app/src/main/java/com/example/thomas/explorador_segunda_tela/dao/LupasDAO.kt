...
class LupasDAO(val context: Context) {
    ...
    init {
        ...
        var lupa = Lupa("Sistema métrico",
                ...
                R.mipmap.foto1_sistema_metrico,
                R.mipmap.foto1_sistema_metrico)
        lupas.add(lupa)
        lupa = Lupa("Geografia",
        ...
        lupa = Lupa("Alternos internos",
                ...
                R.mipmap.foto1_alternos_internos,
                R.mipmap.foto1_alternos_internos)
        lupas.add(lupa)
